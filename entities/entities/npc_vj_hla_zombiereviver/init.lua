...
ENT.Model = {"models/creatures/zombies/zombie_citizen_reviver.mdl","models/creatures/zombies/zombie_hazmat_worker_male_reviver.mdl","models/creatures/zombies/zombie_combine_worker_reviver.mdl","models/creatures/zombies/zombie_c17_reviver.mdl","models/creatures/zombies/zombie_v2_reviver.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
...
function ENT:CustomOnInitialize()
	if self.ReviverSpawned == true then
		if self.Citizen == true then
			self:SetModel("models/creatures/zombies/zombie_citizen_reviver.mdl")
			if self.CitizenShirt == true then
				self:SetBodygroup(self:FindBodygroupByName("vest"),1)
			end
		elseif self.Worker == true then
			self:SetModel("models/creatures/zombies/zombie_combine_worker_reviver.mdl")
		elseif self.C17 == true then
			self:SetModel("models/creatures/zombies/zombie_c17_reviver.mdl")
		elseif self.Hazmat == true then
			self:SetModel("models/creatures/zombies/zombie_hazmat_worker_male_reviver.mdl")
		elseif self.Classic == true then
			self:SetModel("models/creatures/zombies/zombie_classic_reviver.mdl")
		elseif self.Unused == true then
			self:SetModel("models/creatures/zombies/zombie_v2_reviver.mdl")
		end
...
function ENT:CustomOnThink()
	...
	if self.Classic == false then
		self.FootStep = {"creatures/zombie/foley/move_01.wav","creatures/zombie/foley/move_02.wav","creatures/zombie/foley/move_03.wav","creatures/zombie/foley/move_04.wav","creatures/zombie/foley/move_05.wav","creatures/zombie/foley/move_06.wav","creatures/zombie/foley/move_07.wav","creatures/zombie/foley/move_08.wav","creatures/zombie/foley/move_09.wav","creatures/zombie/foley/move_10.wav","creatures/zombie/foley/move_11.wav","creatures/zombie/foley/move_12.wav","creatures/zombie/foley/move_13.wav","creatures/zombie/foley/move_14.wav"}
		self.SoundTbl_BeforeMeleeAttack = {"creatures/zombie/vox/attack_pre_01.wav","creatures/zombie/vox/attack_pre_02.wav","creatures/zombie/vox/attack_pre_03.wav","creatures/zombie/vox/attack_pre_04.wav"}
		self.SoundTbl_MeleeAttack = {"creatures/zombie/attack_hit_01.wav","creatures/zombie/attack_hit_02.wav","creatures/zombie/attack_hit_03.wav","creatures/zombie/attack_hit_04.wav","creatures/zombie/attack_hit_05.wav","creatures/zombie/attack_hit_06.wav"}
		self.SoundTbl_MeleeAttackMiss = {"creatures/zombie/vox/attack_miss_01.wav","creatures/zombie/vox/attack_miss_02.wav","creatures/zombie/vox/attack_miss_03.wav"}
		self.AttackGrunt = {"creatures/zombie/vox/attack_grunt_01.wav","creatures/zombie/vox/attack_grunt_02.wav","creatures/zombie/vox/attack_grunt_03.wav","creatures/zombie/vox/attack_grunt_04.wav","creatures/zombie/vox/attack_grunt_05.wav","creatures/zombie/vox/attack_grunt_06.wav","creatures/zombie/vox/attack_grunt_07.wav"}
		self.AttackWhoosh = {"creatures/zombie/attack_whoosh_01.wav","creatures/zombie/attack_whoosh_02.wav","creatures/zombie/attack_whoosh_03.wav","creatures/zombie/attack_whoosh_04.wav","creatures/zombie/attack_whoosh_05.wav"}
	else
		self.FootStep = {"npc/zombie/foot1.wav","npc/zombie/foot2.wav","npc/zombie/foot3.wav"}
		self.SoundTbl_BeforeMeleeAttack = {"npc/zombie/zo_attack1.wav","npc/zombie/zo_attack2.wav"}
